...
当前分支处于 **design-ready / implementation-not-started**：

- 产品入口和边界已定义；
- Phase 1 领域模型、Schema、协议、状态机和验收已定义；
...
[15 项验收](./TECH-PLAN.md#15-phase-1-验收) 为完成标准。

Phase 1 可以使用 Agent Runtime 原生认证，但必须显示 `native_auth`，不能宣称已经具备
Credential Broker 隔离。真实 Broker 代发属于 Phase 2。
